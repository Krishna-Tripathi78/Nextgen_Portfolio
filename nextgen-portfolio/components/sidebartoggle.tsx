...
function SidebarToggle() {
  ...
  const buttonStyles = `relative w-16 h-16 rounded-full 
    ...
    dark:from-blue-600 dark:via-cyan-600 dark:to-teal-600 
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      {/* Animated rings */}
      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-500 to-teal-500 opacity-20 blur-2xl animate-ping [animation-duration:2s]" />
      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 opacity-30 blur-xl animate-pulse [animation-duration:3s]" />

      {/* Sparkle badge */}
      <div className="absolute -top-1 -right-1 z-10">
        <div className="h-6 w-6 rounded-full bg-gradient-to-br from-green-400 to-emerald-500 shadow-lg flex items-center justify-center animate-bounce [animation-duration:2s]">
