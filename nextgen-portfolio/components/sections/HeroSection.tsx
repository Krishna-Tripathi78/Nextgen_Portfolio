...
export async function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen h-screen flex items-center justify-center px-4 py-8 sm:px-6 sm:py-12 lg:px-8 overflow-hidden"
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="@container/hero space-y-3 sm:space-y-4 md:space-y-6 text-center lg:text-left order-2 lg:order-1">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-2 sm:gap-3 md:gap-4 pt-2 sm:pt-4">
                  {profile.socialLinks.github && (
                    <Link
                      ...
                      className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-lg border border-cyan-600/50 bg-cyan-500/20 hover:bg-cyan-500/30 hover:border-cyan-500 transition-all text-xs sm:text-sm md:text-base text-cyan-700 dark:text-cyan-100 dark:border-cyan-500/30 dark:bg-cyan-500/10"
                    >
                  ...
                  {profile.socialLinks.linkedin && (
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-lg border border-blue-600/50 bg-blue-500/20 hover:bg-blue-500/30 hover:border-blue-500 transition-all text-xs sm:text-sm md:text-base text-blue-700 dark:text-blue-100 dark:border-blue-500/30 dark:bg-blue-500/10"
                    >
                  ...
                  {profile.socialLinks.twitter && (
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-lg border border-sky-600/50 bg-sky-500/20 hover:bg-sky-500/30 hover:border-sky-500 transition-all text-xs sm:text-sm md:text-base text-sky-700 dark:text-sky-100 dark:border-sky-500/30 dark:bg-sky-500/10"
                    >
                  ...
                  {profile.socialLinks.website && (
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-lg border border-teal-600/50 bg-teal-500/20 hover:bg-teal-500/30 hover:border-teal-500 transition-all text-xs sm:text-sm md:text-base text-teal-700 dark:text-teal-100 dark:border-teal-500/30 dark:bg-teal-500/10"
                    >
              ...
              >
                ...
                {profile.location && (
                  <div className="flex items-center gap-1.5 sm:gap-2 text-blue-600 dark:text-blue-400 hover:scale-110 transition-transform">
                    <MapPin className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                    <span className="truncate">{profile.location}</span>
                  </div>
                )}
                {profile.availability && (
                  <div className="flex items-center gap-1.5 sm:gap-2 text-teal-600 dark:text-teal-400 hover:scale-110 transition-transform">
